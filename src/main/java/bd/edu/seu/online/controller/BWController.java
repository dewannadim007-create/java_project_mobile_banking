...
public class BWController {
    ...
    public void transfer()
    {
        ...
        if(haveAccount && remainingBalance>amount && pinVerification && !accountCheck )
        {
            ...
            TransactionServices.transactionHistory(  new Transaction(receiverWallet, LocalDate.now().toString(),amount,"bank to wallet",HelloApplication.loggedUser.getAccount()));
